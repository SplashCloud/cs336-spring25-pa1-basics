...
def run_linear(
    ...
    """
    from cs336_basics.base_modules import Linear
...
def run_embedding(
    ...
    """
    from cs336_basics.base_modules import Embedding
    embedding = Embedding(num_embeddings=vocab_size, embedding_dim=d_model)
    embedding.load_state_dict({"vocab": weights}, strict=False)
...
def run_swiglu(
    ...
    from cs336_basics.base_modules import SwiGLU
    swiglu = SwiGLU(d_model=d_model, d_ff=d_ff)
    swiglu.load_state_dict({"W1": w1_weight, "W2": w2_weight, "W3": w3_weight}, strict=False)
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.base_modules import scaled_dot_product_attention
...
def run_multihead_self_attention_with_rope(
    ...
    return multihead_self_attention.forward(x=in_features, token_positions=token_positions)
...
def run_rope(
    ...
    """
    from cs336_basics.base_modules import RoPE
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.base_modules import RMSNorm
...
def run_get_batch(
    ...
    """
    from cs336_basics.train_modules import data_loading
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.train_modules import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.train_modules import gradient_clipping
...
def run_get_lr_cosine_schedule(
    ...
    return learning_rate_schedule(current_t=it, max_lr=max_learning_rate, min_lr=min_learning_rate, warmup_t=warmup_iters, cosine_annealing_t=cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.train_modules import save_checkpoint
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.train_bpe import run, run_fast
    return run_fast(input_path=input_path, max_vocab_size=vocab_size, special_tokens=special_tokens)
